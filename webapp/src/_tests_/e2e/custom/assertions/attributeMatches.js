...
exports.assertion = function(selector, attribute, regexp, msg = null) {
  this.message = msg
  if (!this.message) {
  ...
  this.pass = value => this.expected.test(value)
  ...
  this.command = callback => this.api.getAttribute(selector, attribute, callback)
}
